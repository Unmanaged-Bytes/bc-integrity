...
static int fixture_setup(void **state) {
  ...
  snprintf(fixture->manifest_path_a, sizeof(fixture->manifest_path_a),
           "/tmp/bc_integrity_diff_ext_%d_a.hrbl", getpid());
  snprintf(fixture->manifest_path_b, sizeof(fixture->manifest_path_b),
           "/tmp/bc_integrity_diff_ext_%d_b.hrbl", getpid());
...
static int run_diff(fixture_state_t *fixture, bool ignore_meta,
                    bool ignore_mtime, bc_integrity_output_format_t format) {
...
static void test_diff_empty_vs_empty_no_diff(void **state) {
  fixture_state_t *fixture = (fixture_state_t *)*state;
  write_manifest(fixture->memory_context, fixture->manifest_path_a, NULL, 0,
                 BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, NULL, 0,
                 BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, false,
...
static void test_diff_empty_vs_populated_returns_diff(void **state) {
  ...
  make_file_entry(
      &entries_b[0], "added_one.txt",
      "1111111111111111111111111111111111111111111111111111111111111111", 0644,
      1700000000);
  make_file_entry(
      &entries_b[1], "added_two.txt",
      "2222222222222222222222222222222222222222222222222222222222222222", 0644,
      1700000000);
  write_manifest(fixture->memory_context, fixture->manifest_path_a, NULL, 0,
                 BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries_b,
                 2, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, false,
                            BC_INTEGRITY_OUTPUT_FORMAT_TEXT),
                   1);
}
...
static void test_diff_populated_vs_empty_returns_diff(void **state) {
  ...
  make_file_entry(
      &entries_a[0], "removed.txt",
      "3333333333333333333333333333333333333333333333333333333333333333", 0644,
      1700000000);
  write_manifest(fixture->memory_context, fixture->manifest_path_a, entries_a,
                 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, NULL, 0,
                 BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, false,
                            BC_INTEGRITY_OUTPUT_FORMAT_TEXT),
...
static void test_diff_invalid_manifest_a_returns_two(void **state) {
  ...
  make_file_entry(
      &entries_b[0], "x.txt",
      "4444444444444444444444444444444444444444444444444444444444444444", 0644,
      1700000000);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries_b,
                 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, false,
...
static void test_diff_ignore_mtime_skips_only_mtime_change(void **state) {
  ...
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries_b,
                 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, true,
                            BC_INTEGRITY_OUTPUT_FORMAT_TEXT),
                   0);
}
...
static void test_diff_ignore_meta_skips_meta_only_changes(void **state) {
  ...
  make_file_entry(
      &entries_b[0], "x.txt",
      "5555555555555555555555555555555555555555555555555555555555555555", 0700,
      1700000000);
  write_manifest(fixture->memory_context, fixture->manifest_path_a, entries_a,
                 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries_b,
                 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, true, false,
                            BC_INTEGRITY_OUTPUT_FORMAT_TEXT),
                   0);
}
...
static void test_diff_both_change_classified_json(void **state) {
  ...
  make_file_entry(
      &entries_b[0], "x.txt",
      "9999999999999999999999999999999999999999999999999999999999999999", 0700,
      1700000000);
  write_manifest(fixture->memory_context, fixture->manifest_path_a, entries_a,
                 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries_b,
...
static void test_diff_json_format_runs_clean(void **state) {
  ...
  make_file_entry(
      ...
      "8888888888888888888888888888888888888888888888888888888888888888", 0700,
      1700000000);
  write_manifest(fixture->memory_context, fixture->manifest_path_a, entries_a,
                 2, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries_b,
...
static void test_diff_symlink_kind_preserved(void **state) {
  ...
  write_manifest(fixture->memory_context, fixture->manifest_path_a,
                 &link_entry, 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b,
                 &link_entry_b, 1, BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, false,
                            BC_INTEGRITY_OUTPUT_FORMAT_TEXT),
                   1);
}
...
static void test_diff_fifo_socket_device_kinds(void **state) {
  ...
  write_manifest(fixture->memory_context, fixture->manifest_path_a, entries, 3,
                 BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  write_manifest(fixture->memory_context, fixture->manifest_path_b, entries, 3,
                 BC_INTEGRITY_DIGEST_ALGORITHM_SHA256);
  assert_int_equal(run_diff(fixture, false, false,
                            BC_INTEGRITY_OUTPUT_FORMAT_TEXT),
                   0);
...
int main(void) {
  const struct CMUnitTest tests[] = {
      cmocka_unit_test_setup_teardown(test_diff_empty_vs_empty_no_diff,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_empty_vs_populated_returns_diff,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_populated_vs_empty_returns_diff,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_invalid_manifest_a_returns_two,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_ignore_mtime_skips_only_mtime_change,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_ignore_meta_skips_meta_only_changes,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_content_change_detected,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_both_change_classified_json,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_json_format_runs_clean,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_symlink_kind_preserved,
                                      fixture_setup, fixture_teardown),
      cmocka_unit_test_setup_teardown(test_diff_fifo_socket_device_kinds,
                                      fixture_setup, fixture_teardown),
  };
