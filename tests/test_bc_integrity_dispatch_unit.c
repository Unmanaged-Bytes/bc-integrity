...
static int fixture_setup(void **state) {
  ...
  snprintf(fixture->directory_path, sizeof(fixture->directory_path),
           "/tmp/bc_integrity_dispatch_test_%d_XXXXXX", getpid());
...
int main(void) {
  const struct CMUnitTest tests[] = {
      cmocka_unit_test_setup_teardown(test_dispatch_two_files, fixture_setup,
                                      fixture_teardown),
      cmocka_unit_test_setup_teardown(test_dispatch_zero_size_file,
