...
static void test_parse_threads_invalid(void **state) {
  ...
  assert_false(
      bc_integrity_cli_parse_threads("auto-cpu", &mode, &worker_count));
}

int main(void) {
  const struct CMUnitTest tests[] = {
      cmocka_unit_test(test_parse_digest_algorithm_valid),
      cmocka_unit_test(test_parse_digest_algorithm_invalid),
      cmocka_unit_test(test_parse_threads_auto),
      cmocka_unit_test(test_parse_threads_auto_io),
      cmocka_unit_test(test_parse_threads_zero),
      cmocka_unit_test(test_parse_threads_explicit),
